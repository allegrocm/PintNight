package org.flixel.system
{
	...
	public class FlxPreloader extends MovieClip
	{
		...
		public function FlxPreloader()
		{
			...
			var tmp:Bitmap;
			if(!FlxG.debug && (myURL != null) && (root.loaderInfo.url.indexOf(myURL) < 0) && (root.loaderInfo.url.substr(0, 7)!="file://"))
			{
				...
				textField.text = "Hi there!  It looks like somebody copied this game without our permission.  Just click anywhere, or copy-paste this URL into your browser.\n\n"+myURL+"\n\nto play the game at the site.  Thanks, and have fun!";
				addChild(textField);
