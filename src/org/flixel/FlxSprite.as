	...
	public class FlxSprite extends FlxObject
	{
		...
		*/
		...
		override public function draw():void
		{
			...
			// SI: fix for cumulative rounding error
			var realX:Number = x;
			var realY:Number = y;
			// SI: Manually snap, pretty sure the native default is round which results in precision-related rounding errors
			x = Math.floor(x);
			y = Math.floor(y);
			...
			// SI: restore realX/Y so that cumulative subpixel changes still work
			x = realX;
			y = realY;
		}
